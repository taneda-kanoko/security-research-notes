...
> **監視システム自身が攻撃対象となる場合の検知アーキテクチャを分析。**  
> 単一の SIEM に依存する構造的リスクと、観測点・通知経路・ログ保存の独立性（Observer Redundancy）を考察しています。

| ファイル | 対象インシデント | 主要テクニック |
|---|---|---|
| [Splunk Pre-Auth RCE と監視系冗長化（2026-07）](./security-architecture/splunk-monitoring-system-defense-2026.md) | CVE-2026-20253: 未認証RCEによる監視ツール侵害（CISA KEV登録） | T1190, T1059, T1562 |
